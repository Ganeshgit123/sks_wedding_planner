                            ...
                            <div class="row no-gutters">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <div class="border pt-35 pr-30 pb-40 pl-30">
                                        ...
                                        <form id="contact-form" method="post" action="contact/contact.php" class="contactform wrap-form pt-5 clearfix">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <label>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <label>
                                                        <span class="text-input"><input name="phone" type="number" value="" placeholder="Phone*" required="required"></span>
                                                    </label>
                                                </div>
                                                <div class="col-md-6">
                                                    <label>
                                                        <span class="text-input"><input name="yourevent" type="text" value="" placeholder="Your-event*" required="required"></span>
                                                    </label>
                                                </div>
                                            </div>
                                            <label>
                                                <span class="text-input"><input name="sub" type="text" value="" placeholder="Subject"></span>
                                            </label>
                                            <label>
